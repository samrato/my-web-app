  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    ...
    <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
      <div className="mx-auto max-w-sm lg:max-w-none">
        ...
        Want to be the first to hear about the latest developments, innovations, and blockbuster news from Willyma Technology? Subscribe to our email updates and never miss a beat on how we’re pushing the boundaries in tech solutions.
        </p>
    ...
    <div className="mt-16 border-t border-gray-100 pt-8">
      <p className="text-center text-xs/relaxed text-gray-500">
        ...
        Created with
        <a href="#" className="text-gray-700 underline transition hover:text-gray-700/75">Samrata</a>
        de 
